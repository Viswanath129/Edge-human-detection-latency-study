    ...
    if os.path.exists(summary_path):
        try:
            ...
            if "Model" not in df.columns or "Precision" not in df.columns:
                print("Legacy summary detected. Migrating to new schema.")
